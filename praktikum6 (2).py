...
Original file is located at
    https://colab.research.google.com/drive/1Cq-xjvolZ9R8dBgwRyFaDGHQJwuyzOS7
"""
...
#mendapatkan revolusi dan type gambar
...
#membuat variabel untuk menyimpan image
hg = np.zeros((256))
...
#membuat variabel untuk menyimpan data image
hgr = np.zeros((256))
hgg = np.zeros((256))
hgb = np.zeros((256))
hgrgb = np.zeros((768))

#mengisi setiap nilai dalam array hgr dengan 0
for x in range(0, 256):
    hgr[x] = 0
    hgg[x] = 0
    hgb[x] = 0
